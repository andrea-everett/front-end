       ...
       <article className="br2 ba dark-gray b--black-10 mv6 w-100 w-50-m w-25-1 center">
          <main className="pa4 black-80">
             <div className="measure center">
              ...
              <div class="mt3">
          <label class="db fw6 lh-copy f6" forhtml="name">Name</label>
          <input 
        ...
        <div className="mt3">
          <label className="db fw6 lh-copy f6" forhtml="password">Email</label>
          <input 
        ...
        <div className='mv3'>
        <label className="pa0 ma0 lh-copy f6 pointer" htmlFor="password">Password</label>
      <input
